...
class OpenAi(commands.Cog):
    ...
    async def summarize_chat(self, ctx: Context):
        ...
        prompt = (
            ...
            "- The bullet list must be very short and concise.\n"
            ...
            "Example Output:\n"
            "----------------\n"
            "- User asked about the weather in Paris. {message:2}\n"
            "- Discussed the history of the Eiffel Tower. {message:4}\n"
            "- Advised on popular restaurants in Paris. {message:7}\n"
            "----------------\n\n"
            "Command to Begin:\n"
